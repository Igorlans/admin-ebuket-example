...
import comment from "@/components/PageComponents/assortment/Decor/DecorItem/comment/Comment";

const Comment = ({flower, comment, handleSaveComment, isEditingComment, newComment, setNewComment, setIsEditingComment}) => {
    return (
      <>
            {comment ? (
